      ...
      <div className="container-wide">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
<li><a href="https://flangecatalog.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition">Flange Catalog</a></li>
<li><a href="https://asmeflanges.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition">ASME Flanges</a></li>
<li><a href="https://lightweightflanges.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition">Lightweight Flanges</a></li>
